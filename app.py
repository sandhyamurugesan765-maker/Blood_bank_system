...
def search_blood():
    ...
    if request.method == 'POST':
        ...
        query += ' ORDER BY last_donation_date ASC'  # Show those who haven't donated recently first
...
def history():
    ...
    query = '''
        SELECT donation_id, donor_id, donor_name, blood_group, units_donated,
               donation_date, expiry_date, received_by, test_result, notes
        FROM donation_history
        WHERE 1=1
    '''
    params = []
