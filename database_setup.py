...
def init_database():
    ...
    sample_donors = [
        ('DON10001', 'Michael Johnson', '1990-05-15', 33, 'Male', 'O+', 'New York', '555-0101', 'michael@email.com', 'No medical issues', 75.5, 180.0, '2023-10-15', 1, 'Active'),
        ('DON10002', 'Sarah Williams', '1985-08-22', 38, 'Female', 'A-', 'Los Angeles', '555-0102', 'sarah@email.com', 'Allergic to penicillin', 62.0, 165.0, '2023-09-20', 1, 'Active'),
        ('DON10003', 'David Brown', '1995-02-10', 28, 'Male', 'B+', 'Chicago', '555-0103', 'david@email.com', 'Asthma controlled', 80.0, 175.0, '2023-11-05', 1, 'Active'),
        ('DON10004', 'Lisa Taylor', '1988-11-30', 35, 'Female', 'AB-', 'Houston', '555-0104', 'lisa@email.com', 'No issues', 58.0, 160.0, '2023-08-10', 0, 'Temporarily Deferred'),
        ('DON10005', 'James Wilson', '1992-07-18', 31, 'Male', 'O-', 'Phoenix', '555-0105', 'james@email.com', 'Universal donor', 85.0, 182.0, '2023-12-01', 1, 'Active'),
        ('DON10006', 'Maria Garcia', '1998-04-25', 25, 'Female', 'A+', 'Philadelphia', '555-0106', 'maria@email.com', 'No medical issues', 61.0, 162.0, None, 1, 'Active'),
        ('DON10007', 'Robert Miller', '1975-12-05', 48, 'Male', 'B-', 'San Antonio', '555-0107', 'robert@email.com', 'High blood pressure controlled', 90.0, 178.0, '2023-07-22', 1, 'Active'),
        ('DON10008', 'Jennifer Davis', '1982-09-14', 41, 'Female', 'AB+', 'San Diego', '555-0108', 'jennifer@email.com', 'No issues', 59.0, 158.0, '2023-11-15', 1, 'Active'),
    ]
